                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group m-1">
                                            ...
                                            <button type="button" class="btn btn-danger waves-effect waves-light btn-sm" onclick="confirm('Are you sure you want to remove ?') || event.stopImmediatePropagation()"><i class="fa fa fa-trash-o"></i></button>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
