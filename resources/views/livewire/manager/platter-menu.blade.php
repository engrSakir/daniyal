<div class="container-fluid">
    ...
    <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            <h4 class="page-title">Platter Menu Page</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javaScript:void();">{{ config('app.name') }}</a></li>
                <li class="breadcrumb-item"><a href="javaScript:void();">Pages</a></li>
                <li class="breadcrumb-item active" aria-current="page">Platter Menu Page</li>
            </ol>
        </div>
        <div class="col-sm-3">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset($platter_menu->image ? $platter_menu->image : 'assets/images/no-image.png') }}" width="50px">
                                        {{ $platter_menu->name }}
                                    </td>
                                    <td>{{ $platter_menu->price }}</td>
                                    <td>
                                        @if ($platter_menu->online_active)
                                    ...
                                    <td>
                                        @if ($platter_menu->offline_active)
                                        <span class="badge badge-pill badge-success m-1">Active</span>
                                        @else
                                        <span class="badge badge-pill badge-danger m-1">Inactive</span>
                                        @endif
                                    ...
                                    <td>
                                        <div class="btn-group m-1">
                                            <button type="button" class="btn btn-warning waves-effect waves-light" data-toggle="modal" data-target="#modal" wire:click="select_model({{ $platter_menu }})"><i class="fa fa-edit"></i></button>
