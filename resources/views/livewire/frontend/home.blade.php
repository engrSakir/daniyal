<div>
    <!-- section start -->
    <section class="section-big-pt-space ratio_asos b-g-light" wire:ignore>
                                                    ...
                                                    <div class="col-12 position-relative">
                                                        <div class="product-filter-content horizontal-filter-mian ">
                                                            ...
                                                            <div class="horizontal-filter collection-filter">
                                                                                ...
                                                                                <div class="size-selector">
                                                                                    <div class="collection-brand-filter">
                                                                                        <div class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                                                            <input type="checkbox" class="custom-control-input form-check-input" id="xssmall">
                                                                                            <label class="custom-control-label form-check-label" for="xssmall">xs</label>
                                                                                        </div>
                                                                                        <div class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                                                        ...
                                                                                        <div class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                                                            <input type="checkbox" class="custom-control-input form-check-input" id="2extralarge">
                                                                                            <label class="custom-control-label form-check-label" for="2extralarge">2xl</label>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="collection-collapse-block">
                                                                            ...
                                                                            <div class="collection-collapse-block-content">
                                                                                <div class="size-selector">
                                                                                    <div class="collection-brand-filter">
                                                                                        <div class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                                                            <input type="checkbox" class="custom-control-input form-check-input" id="hundred">
                                                                                            <label class="custom-control-label form-check-label" for="hundred">$10 -
                                                                                                $100</label>
                                                                                        </div>
                                                                                        <div class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                                                            <input type="checkbox" class="custom-control-input form-check-input" id="twohundred">
                                                                                            <label class="custom-control-label form-check-label" for="twohundred">$100 -
                                                                                                $200</label>
                                                                                        </div>
                                                                                        <div class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                                                            <input type="checkbox" class="custom-control-input form-check-input" id="threehundred">
                                                                                            <label class="custom-control-label form-check-label" for="threehundred">$200 -
                                                                                                $300</label>
                                                                                        </div>
                                                                                        <div class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                                                            <input type="checkbox" class="custom-control-input form-check-input" id="fourhundred">
                                                                                            <label class="custom-control-label form-check-label" for="fourhundred">$300 -
                                                                                                $400</label>
                                                                                        </div>
                                                                                        <div class="custom-control custom-checkbox  form-check collection-filter-checkbox">
                                                                                            <input type="checkbox" class="custom-control-input form-check-input" id="fourhundredabove">
                                                                                            <label class="custom-control-label form-check-label" for="fourhundredabove">$400
                                                                                                above</label>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                ...
                                                                <a href="javascript:void(0)" class="btn btn-solid btn-sm close-filter"> close
                                                                    filter</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="product-box">
                                                        ...
                                                        <div class="product-detail detail-center detail-inverse">
                                                            ...
                                                            <div class="icon-detail">
                                                                ...
                                                                <a href="javascript:void(0)" wire:click="select_product_for_quick_view({{ $category_wise_item->id }})"> <i data-feather="eye"></i></a>
