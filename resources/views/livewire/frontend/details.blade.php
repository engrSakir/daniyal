                                    ...
                                    <div class="product-right ">
                                        ...
                                        <div id="selectSize" class="pro-group addeffect-section product-description border-product">
                                            ...
                                            <div class="qty-box">
                                                <div class="input-group">
                                                    <button class="qty-minus" wire:click="$emit('updateQuantity', {{ $category_wise_item->id }}, '-')"></button>
                                                    <input class="form-control" readonly type="number" value="{{ $quantity }}" />
                                                    <button class="qty-plus" wire:click="$emit('updateQuantity', {{ $category_wise_item->id }}, '+')"></button>
                                                </div>
                                            </div>
                                            <div class="product-buttons">
                                                <a href="javascript:void(0)" id="cartEffect" class="btn cart-btn btn-normal tooltip-top" wire:click="$emit('addToCard', '{{ $category_wise_item->id }}')">
                                        ...
                                        <div class="pro-group pb-0">
                                            ...
                                            <ul class="product-social">
                                                <li><a href="javascript:void(0)" data-sharer="facebook" data-hashtags="{{ config('app.name') }}" data-url="{{ url()->full() }}"><i class="fa fa-facebook"></i></a></li>
                                                <li><a href="javascript:void(0)" data-sharer="twitter" data-title="{{ config('app.name') }}" data-hashtags="{{ config('app.name') }}" data-url="{{ url()->full() }}"><i class="fa fa-twitter"></i></a></li>
                                                <li><a href="javascript:void(0)" data-sharer="linkedin" data-url="{{ url()->full() }}"><i class="fa fa-linkedin"></i></a></li>
                                                <li><a href="javascript:void(0)" data-sharer="email" data-title="{{ config('app.name') }}" data-subject="Hey! Check out that URL" data-to="{{ config('app.reporting_email') }}"><i class="fa fa-envelope"></i></a></li>
                                                <li><a href="javascript:void(0)" data-sharer="whatsapp" data-title="{{ config('app.name') }}" data-url="{{ url()->full() }}"><i class="fa fa-whatsapp"></i></a></li>
                                                <li><a href="javascript:void(0)" data-sharer="telegram" data-title="{{ config('app.name') }}" data-url="{{ url()->full() }}"><i class="fa fa-telegram"></i></a></li>
                                                <li><a href="javascript:void(0)" data-sharer="skype" data-url="{{ url()->full() }}"><i class="fa fa-skype"></i></a></li>
                                                {{-- <li><a href="javascript:void(0)" data-sharer="instagram" data-title="{{ config('app.name') }}" data-hashtags="{{ config('app.name') }}" data-url="{{ url()->full() }}"><i class="fa fa-instagram"></i></a></li> --}}
                                            </ul>
                                        </div>
                                    </div>
                                </div>
