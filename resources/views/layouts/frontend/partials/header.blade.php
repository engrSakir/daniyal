                                ...
                                <li class="mobile-setting" onclick="openSetting()">
                                    <a href="javascript:void(0)">
                                        <svg enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="m256 367.4c-61.427 0-111.4-49.974-111.4-111.4s49.973-111.4 111.4-111.4 111.4 49.974 111.4 111.4-49.973 111.4-111.4 111.4zm0-192.8c-44.885 0-81.4 36.516-81.4 81.4s36.516 81.4 81.4 81.4 81.4-36.516 81.4-81.4-36.515-81.4-81.4-81.4z" /></svg>
                                    </a>
                                </li>
                        ...
                        <div class="menu-block">
                            <nav id="main-nav">
                                ...
                                <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                    ...
                                    <!--HOME-->
                                    <li><a class="dark-menu-item" href="{{ route('home') }}">Home</a></li>
                                    <li><a class="dark-menu-item" href="javascript:void(0)">About</a></li>
                                    <li><a class="dark-menu-item" href="javascript:void(0)">Contact</a></li>
                                    <!--HOME-END-->
                                </ul>
                            </nav>
                        </div>
                        ...
                        <div class="category-right">
                            <div class="contact-block">
                                <div>
                                    ...
                                    <span>call us<span>+880 1304-734623</span></span>
                                </div>
                            </div>
                            <div class="btn-group">
